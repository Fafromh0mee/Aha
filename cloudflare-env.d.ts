/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: fc531d20f8837dec8b6241cd7b31d79d)
// Runtime types generated with workerd@1.20260826.1 2026-08-29 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	ASSETS: Fetcher;
	CLASSROOM_ROOM: DurableObjectNamespace<import("./custom-worker").ClassroomRoom>;
	WORKER_SELF_REFERENCE: Service<typeof import("./custom-worker").default>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./custom-worker");
		durableNamespaces: "ClassroomRoom";
	}
